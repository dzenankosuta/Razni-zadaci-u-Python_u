...
def compress_img(image_name, new_size_ratio=0.9, quality=55, width=None, height=None, to_webp=True):
...
#     parser.add_argument("-webp", "--to-webp", action="store_true", help="Whether to convert the image to the WEBP format")
...
#     print("="*50)
#     # compress the image
#     compress_img(args.image, args.resize_ratio, args.quality, args.width, args.height, args.to_webp)

compress_img("/folder/image_name.extension")